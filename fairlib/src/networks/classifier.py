...
class MLP(BaseModel):
    ...
    def hidden(self, input_data, group_label = None, return_first_hidden=False):
...
class BERTClassifier(BaseModel):
    ...
    def __init__(self, args):
        ...
        self.args = args
        self.n_freezed_layers = args.n_freezed_layers
    ...
    def hidden(self, input_data, group_label = None, return_first_hidden=False):
        ...
        return self.classifier.hidden(bert_output, group_label, return_first_hidden)
